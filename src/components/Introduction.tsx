...
const Introduction = () => {
  ...
  return (
    <div style={{ backgroundColor: Colors.ghostWhiteStrong, minHeight: '100vh', padding: 50, display: 'flex', flexDirection: 'column' }}>
      <div className="intro-content" style={{ display: 'flex', alignItems: 'center', minHeight: '80vh' }}>
        <img src='me.jpeg' alt='Picture of Adrian' className="intro-img animate-on-load" style={{ height: 'auto', boxShadow: '15px 15px #F80C46' }}/> 
        <div className="intro-div-text" style={{ height: 'auto',   wordWrap: 'break-word',   whiteSpace: 'normal', backgroundColor: Colors.ghostWhiteStrong, textAlign: 'center', paddingTop: 50, paddingBottom: 50, marginLeft: 'auto', marginRight: 'auto' }}>
